...
public class TestProvider extends AndroidTestCase {
    ...
    public void testUpdateLocation() {
        ...
        //new updated values that we want to update in the DB for a specific record
        ...
        //see the record with the updated data
        Cursor cursor = mContext.getContentResolver().query(
                LocationEntry.CONTENT_URI,
                null,   // projection
    ...
    public void testInsertReadProvider() {
        ...
        //fetch the row _id from the uri created from insert statement
        long locationRowId = ContentUris.parseId(locationUri);
        ...
        //register observer to new URI (weather URI)
        ...
        Log.v("Weather Uri with L",String.valueOf(WeatherEntry.buildWeatherLocation(TestUtilities.TEST_LOCATION)));
    ...
    public void testBulkInsert() {
        ...
        Log.e("**BULK INSERT COUNT",String.valueOf(cursor.getCount())); //10 records
